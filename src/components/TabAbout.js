    ...
    <div className="p-4">
      ...
      <Text fontSize="md" className="mt-4">
        <div className="text-lg md:text-xl flex flex-col">
          {" "}
          <span className="text-[#8c4e1d] font-semibold">{t("single.pincode")}</span>{" "}
          <span className="mt-1">{policeData.address}</span>{" "}
        </div>
      </Text>
      <div className="map-container mt-5">
        <h1 className="text-[#8c4e1d] text-lg md:text-xl font-semibold">{t("single.location")}</h1>
      ...
      <div className="mt-10 flex flex-col md:flex-row gap-2">
        ...
        <IoCallOutline />
        <span className="text-[#8c4e1d] font-semibold">{`${t("single.contactNumber")}: `}</span>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-2 mt-2">
        <div className="flex flex-row gap-2">
        <IoMailOutline/>
        <span className="text-[#8c4e1d] font-semibold">{`${t("single.contactEmail")}: `}</span>
        </div>
