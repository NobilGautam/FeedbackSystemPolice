    ...
    <div>
      <>
        ...
        <Routes>
          ...
          <Route
            path="/admin"
            element={<Admin handleAdminLogin={handleAdminLogin} />}
          ></Route>

          <Route
            path="/singleAdmin/:pincode"
            element={
              <SingleAdmin admin={admin} isAdminLoggedin={isAdminLoggedIn} />
            }
          ></Route>
          ...
          {user && (
            <Route
              path="/feedbackThread/:documentID"
              element={<FeedbackThread />}
            ></Route>
          )}
