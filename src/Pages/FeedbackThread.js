        ...
        {loading ? (
          ...
          <div className="flex flex-col justify-between h-[80vh]">
            ...
            <div className="bg-white rounded-2xl w-[100%] flex flex-col justify-center items-center">
              <Textarea
                value={temp}
                className="border-[2px] border-black rounded-xl my-2 mx-20 max-w-[90%]"
                placeholder="Now talking with Rajasthan Police"
                onChange={handleChange}
              />
              <button
                className="bg-[#ed9a55] p-2 rounded-xl my-3 font-semibold w-[100px] hover:bg-[#965d2f] duration-300"
                onClick={() => {
                  setTemp("");
                  setSubmit(true);
                  if (submit) {
